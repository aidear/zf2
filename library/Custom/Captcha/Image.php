 ...
 * @version CVS: Id: Image.php,v 1.0 2013-10-13 下午7:32:22 Willing Exp
 * @link http://localhost
 * @deprecated File deprecated in Release 3.0.0
 */

namespace Custom\Captcha;

use DirectoryIterator;
use Zend\Captcha\Exception;
use Zend\Stdlib\ErrorHandler;
use Zend\Captcha\Image as Father;
 ...
 */
class Image extends Father
{
	public static $V  = array("a", "e", "i", "o", "u", "y");
	public static $VN = array("a", "e", "i", "o", "u", "y","2","3","5","6","7","8","9");
	public static $C  = array("b","c","d","f","g","h","j","k","m","n","p","q","r","s","t","u","v","w","x","z");
	public static $CN = array("b","c","d","f","g","h","j","k","m","n","p","q","r","s","t","u","v","w","x","z","2","3","5","6","7","8","9");
    /**
     ...
     * @var array
     */
    protected $fontColor = array(115, 143, 69);
    ...
    protected function generateImage($id, $word)
    {
        ...
        $textColor = imagecolorallocate($img, $this->fontColor[0], $this->fontColor[1], $this->fontColor[2]);
